...
//@file:Repository("file:///Users/whoever/.m2/repository")
...
val projectName = "BleGattCoroutines"
val gitHubRepoUrl = "https://github.com/Beepiz/$projectName"
...
val versionsFile = dir.resolve("version.txt")
...
fun CliUi.runReleaseStep(step: ReleaseStep): Unit = when (step) {
    ...
    `Change this library version` -> {
        ...
        OngoingRelease.newVersion.let { newVersion ->
            printInfo("$projectName new version: \"$newVersion\"")
